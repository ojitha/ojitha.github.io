...
For example, protect your DynamoDB table from accidental writes and deletes. When you turn on point-in-time recovery ([PITR](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/PointInTimeRecovery.html)), DynamoDB backs up your table data automatically so that you can restore to any given second in the preceding 1 to 35 days.
