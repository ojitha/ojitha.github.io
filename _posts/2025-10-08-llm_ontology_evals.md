...
excerpt: '<div class="image-text-container"><div class="image-column"><svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" viewBox="0 0 150 150"><rect width="150" height="150" fill="#fef6e4"/><ellipse cx="75" cy="82" rx="68" ry="50" fill="#fde9b8" opacity="0.7"/><ellipse cx="75" cy="110" rx="30" ry="8" fill="#e6d8b9" stroke="#3a2f1d" stroke-width="1.2"/><circle cx="75" cy="102" r="20" fill="#f3c47a" stroke="#3a2f1d" stroke-width="1.4"/><circle cx="75" cy="102" r="16" fill="#e85d3a" opacity="0.85"/><circle cx="69" cy="97" r="2.4" fill="#fff5d4" stroke="#3a2f1d" stroke-width="0.5"/><circle cx="80" cy="100" r="2.2" fill="#fff5d4" stroke="#3a2f1d" stroke-width="0.5"/><circle cx="73" cy="107" r="2.4" fill="#fff5d4" stroke="#3a2f1d" stroke-width="0.5"/><circle cx="82" cy="106" r="1.7" fill="#7a9e3f" stroke="#3a2f1d" stroke-width="0.4"/><circle cx="68" cy="105" r="1.7" fill="#7a9e3f" stroke="#3a2f1d" stroke-width="0.4"/><path d="M22,98 Q22,78 32,78 Q42,78 42,98 Z" fill="#fff8ed" stroke="#3a2f1d" stroke-width="1.2"/><circle cx="32" cy="65" r="8" fill="#fde2c4" stroke="#3a2f1d" stroke-width="1.2"/><ellipse cx="32" cy="55" rx="7" ry="5" fill="#fffaf0" stroke="#3a2f1d" stroke-width="1.2"/><rect x="27" y="58" width="10" height="3" fill="#fffaf0" stroke="#3a2f1d" stroke-width="1.2"/><circle cx="30" cy="65" r="0.9" fill="#3a2f1d"/><circle cx="34" cy="65" r="0.9" fill="#3a2f1d"/><path d="M30,68 Q32,70 34,68" stroke="#3a2f1d" stroke-width="0.8" fill="none"/><path d="M40,82 Q48,90 56,94" stroke="#3a2f1d" stroke-width="1.2" fill="none"/><ellipse cx="120" cy="88" rx="14" ry="17" fill="#b8956a" stroke="#3a2f1d" stroke-width="1.2"/><ellipse cx="120" cy="92" rx="8" ry="10" fill="#f3e2c4"/><circle cx="120" cy="68" r="11" fill="#b8956a" stroke="#3a2f1d" stroke-width="1.2"/><circle cx="116" cy="67" r="3.5" fill="#fffaf0" stroke="#3a2f1d" stroke-width="1"/><circle cx="124" cy="67" r="3.5" fill="#fffaf0" stroke="#3a2f1d" stroke-width="1"/><circle cx="116" cy="67" r="1" fill="#3a2f1d"/><circle cx="124" cy="67" r="1" fill="#3a2f1d"/><path d="M118,70 L120,73 L122,70 Z" fill="#e8a04a" stroke="#3a2f1d" stroke-width="0.6"/><path d="M113,60 L111,55 L115,58 Z" fill="#b8956a" stroke="#3a2f1d" stroke-width="0.8"/><path d="M127,60 L129,55 L125,58 Z" fill="#b8956a" stroke="#3a2f1d" stroke-width="0.8"/><rect x="100" y="88" width="10" height="13" fill="#fffaf0" stroke="#3a2f1d" stroke-width="1"/><line x1="102" y1="92" x2="108" y2="92" stroke="#3a2f1d" stroke-width="0.5"/><line x1="102" y1="95" x2="108" y2="95" stroke="#3a2f1d" stroke-width="0.5"/><line x1="102" y1="98" x2="106" y2="98" stroke="#3a2f1d" stroke-width="0.5"/><text x="6" y="14" font-family="sans-serif" font-size="10" fill="#3a2f1d" font-weight="bold">LLM</text><text x="103" y="40" font-family="sans-serif" font-size="10" fill="#3a2f1d" font-weight="bold">OWL</text><text x="46" y="140" font-family="sans-serif" font-size="9" fill="#7a4a1d" font-weight="bold">SPARQL</text><text x="98" y="140" font-family="sans-serif" font-size="9" fill="#3a2f1d" font-weight="bold">SHACL</text><text x="60" y="80" font-family="sans-serif" font-size="8" fill="#3a2f1d">Pizza</text></svg></div><div class="text-column"><p>Can a Large Language Model write a pizza recipe that actually makes sense? This post turns formal domain ontologies into evaluation frameworks for <b>LLM</b> outputs, using the canonical Stanford Pizza ontology as the running example. The pipeline parses <b>OWL</b> classes and properties, extracts entities from the generated text into RDF triples, then runs reasoners and <b>SHACL</b> shapes to check class membership, cardinality and forbidden combinations. <b>SPARQL</b> ASK queries flag violations such as meat toppings on a vegetarian pizza, yielding factual coverage, relation correctness and logical coherence scores that go far beyond what surface metrics like BLEU or ROUGE can measure.</p></div></div>'
---
