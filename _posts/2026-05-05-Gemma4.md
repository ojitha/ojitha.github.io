---
layout: post
title:  Running Gemma 4 E4B on the AMD ROCm
date:   2026-05-05
categories: [AI]
toc: true
mermaid: true
...
excerpt: '<div class="image-text-container"><div class="image-column"><svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" viewBox="0 0 150 150"><rect width="150" height="150" fill="#1a1f3a"/><path d="M0 95 Q35 70 75 88 T150 85 L150 150 L0 150 Z" fill="#5b3a8b"/><path d="M0 110 Q40 90 80 105 T150 102 L150 150 L0 150 Z" fill="#c44a6a" fill-opacity="0.85"/><circle cx="110" cy="42" r="20" fill="#f4b942"/><circle cx="110" cy="42" r="11" fill="#fef3c7" fill-opacity="0.7"/><path d="M22 50 Q45 35 70 45 Q95 55 125 38" stroke="#1f7d6a" stroke-width="8" fill="none" stroke-linecap="round"/><text x="75" y="68" font-family="sans-serif" font-weight="bold" font-size="14" fill="#fef3c7" text-anchor="middle">Gemma 4</text><text x="75" y="118" font-family="sans-serif" font-weight="bold" font-size="11" fill="#fef3c7" text-anchor="middle">vLLM · ROCm</text><text x="75" y="136" font-family="sans-serif" font-size="9" fill="#fef3c7" text-anchor="middle">Ryzen AI · NPU</text></svg></div><div class="text-column"><p>This deep-dive shows how to run the Google DeepMind <b>Gemma 4</b> E4B model — a 4.5B-effective dense network with Per-Layer Embeddings — on a Minisforum AI X1 Pro driven by the AMD <b>Ryzen AI 9 HX 470</b>, Radeon 890M iGPU and XDNA 2 NPU. It walks the verified <b>vLLM</b> Docker recipe on <b>ROCm</b> 7.2, decomposes the hybrid sliding-window plus global attention that makes a 128K context fit on a 16GB-class memory budget, and shows where MIGraphX can offload an ONNX sidecar to the NPU. The result is a layered guide from architecture math through tuning, quantisation, and benchmarking.</p></div></div>'
---


{% include video-summary.html
   id="D2sECNdgqYE"
   content="The Gemma 4, the 4-billion-effective-parameter instruction-tuned variant
            (<code>google/gemma-4-E4B-it</code>)<sup><a href='/ai/2026/05/05/Gemma4.html#fn:hf-e4b-it'>1</a></sup>.
            This guide grounds Gemma 4 model card in the Ryzen AI 9 HX 470 machine —
            a Minisforum AI X1 Pro with Ryzen AI 9 HX 470, Radeon 890M (gfx1150 / RDNA 3.5),
            XDNA 2 NPU, 64 GiB UMA, ROCm 7.2.0, MIGraphX 2.15.0.dev — and walks from
            &ldquo;what am I&rdquo; through to
            &ldquo;how do I tune your KV cache for 128 K context&rdquo;<sup><a href='/ai/2026/05/05/Gemma4.html#fn:ojitha-rocm'>2</a></sup>.
            The <a href='/ai/2026/05/05/Gemma4.html#docker-gemma4-run'>Docker command</a>
...
[^google-blog]: Google. *Gemma 4: Byte for byte, the most capable open models.* The Keyword, 2 Apr 2026. [https://blog.google/technology/developers/gemma-4/](https://blog.google/technology/developers/gemma-4/){:target="_blank" rel="noopener noreferrer}
...
[^model-card]: Google AI for Developers. *Gemma 4 model card.* [https://ai.google.dev/gemma/docs/core/model_card_4](https://ai.google.dev/gemma/docs/core/model_card_4){:target="_blank" rel="noopener noreferrer}

[^model-overview]: Google AI for Developers. *Gemma 4 model overview.* [https://ai.google.dev/gemma/docs/core](https://ai.google.dev/gemma/docs/core){:target="_blank" rel="noopener noreferrer}

[^hf-e4b-it]: Hugging Face model page. *google/gemma-4-E4B-it.* [https://huggingface.co/google/gemma-4-E4B-it](https://huggingface.co/google/gemma-4-E4B-it){:target="_blank" rel="noopener noreferrer}

[^lmstudio]: LM Studio. *Gemma 4 — supports tool use, vision input, and reasoning.* [https://lmstudio.ai/models/gemma-4](https://lmstudio.ai/models/gemma-4){:target="_blank" rel="noopener noreferrer}

[^ollama-e4b]: Ollama library. *gemma4:e4b — chat template and disabled-thinking behaviour.* [https://ollama.com/library/gemma4:e4b](https://ollama.com/library/gemma4:e4b){:target="_blank" rel="noopener noreferrer}

[^visual-guide]: Maarten Grootendorst. *A Visual Guide to Gemma 4.* Apr 2026. [https://newsletter.maartengrootendorst.com/p/a-visual-guide-to-gemma-4](https://newsletter.maartengrootendorst.com/p/a-visual-guide-to-gemma-4){:target="_blank" rel="noopener noreferrer}

[^aurigait]: Aurigai. *Gemma 4 by Google: Specs, Benchmarks, and How to Run It Locally (2026 Guide).* [https://aurigait.com/blog/gemma-4-features-benchmarks-guide/](https://aurigait.com/blog/gemma-4-features-benchmarks-guide/){:target="_blank" rel="noopener noreferrer}

[^datature]: Datature. *Gemma 4: What Computer Vision Engineers Actually Need to Know.* [https://datature.io/blog/gemma-4-what-computer-vision-engineers-actually-need-to-know](https://datature.io/blog/gemma-4-what-computer-vision-engineers-actually-need-to-know){:target="_blank" rel="noopener noreferrer}

[^ojitha-rocm]: Ojitha Hewa Kumanayaka. *Running AMD ROCm AI Workloads locally.* 7 Mar 2026. [https://ojitha.github.io/ai/2026/03/07/ContainerRocm.html](https://ojitha.github.io/ai/2026/03/07/ContainerRocm.html){:target="_blank" rel="noopener noreferrer}

[^rocm-radeon]: AMD. *vLLM Linux Docker Image — Use ROCm on Radeon and Ryzen.* [https://rocm.docs.amd.com/projects/radeon-ryzen/en/latest/docs/advanced/advancedryz/linux/llm/build-docker-image.html](https://rocm.docs.amd.com/projects/radeon-ryzen/en/latest/docs/advanced/advancedryz/linux/llm/build-docker-image.html){:target="_blank" rel="noopener noreferrer}

[^rocm-vllm-dev]: AMD. *rocm/vllm-dev — Docker Hub overview.* [https://hub.docker.com/r/rocm/vllm-dev](https://hub.docker.com/r/rocm/vllm-dev){:target="_blank" rel="noopener noreferrer}

[^vllm-pr-25908]: Hosang Yoon (AMD). *PR #25908 — Add support for AMD Ryzen AI MAX / AI 300 Series (gfx1150 and gfx1151).* [https://github.com/vllm-project/vllm/pull/25908](https://github.com/vllm-project/vllm/pull/25908){:target="_blank" rel="noopener noreferrer}

[^vllm-dockerfile]: vLLM project. *Dockerfile.rocm — sets `HIP_FORCE_DEV_KERNARG=1` and `SAFETENSORS_FAST_GPU=1` by default.* [https://github.com/vllm-project/vllm/blob/main/docker/Dockerfile.rocm](https://github.com/vllm-project/vllm/blob/main/docker/Dockerfile.rocm){:target="_blank" rel="noopener noreferrer}

[^foxegregore]: FoxEgregore. *rdna35-llm-baremetal — RDNA 3.5 (gfx1150) bare-metal ROCm setup with annotated env vars.* GitHub. [https://github.com/FoxEgregore/rdna35-llm-baremetal](https://github.com/FoxEgregore/rdna35-llm-baremetal){:target="_blank" rel="noopener noreferrer}

[^llm-tracker]: llm-tracker. *AMD GPUs — community notes on RDNA3/3.5 inference paths.* [https://llm-tracker.info/howto/AMD-GPUs](https://llm-tracker.info/howto/AMD-GPUs){:target="_blank" rel="noopener noreferrer}

[^ollama-issue-11451]: ollama/ollama GitHub issue #11451. *GPU not detected on Ryzen AI 300 (gfx1150) with Dynamic VRAM, but works with Fixed VRAM.* [https://github.com/ollama/ollama/issues/11451](https://github.com/ollama/ollama/issues/11451){:target="_blank" rel="noopener noreferrer}
