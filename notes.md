...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/prismjs@1.20.0/plugins/line-numbers/prism-line-numbers.css" />

   <!-- Mermaid -->
    <script type="text/javascript" src="https://cdn.jsdelivr.net/npm/mermaid@8.6.0/dist/mermaid.min.js"></script>
    <script type="text/javascript">
        var config = {
            theme: 'forest',
            themeCSS: '.label div { padding: 0px 0px; }',
            startOnLoad: false,
        };
    ...
    <script type="text/javascript" src="https://cdn.jsdelivr.net/npm/prismjs@1.20.0/plugins/line-numbers/prism-line-numbers.min.js"></script>
    <script type="text/javascript" src="https://cdn.jsdelivr.net/npm/prismjs@1.20.0/plugins/autoloader/prism-autoloader.min.js"></script>
    <script type="text/javascript" src="https://cdn.jsdelivr.net/npm/prismjs@1.20.0/plugins/filter-highlight-all/prism-filter-highlight-all.js"></script>
    <script>
        // <code> elements with a .no-highlight class will be ignored
        Prism.plugins.filterHighlightAll.reject.addSelector('code.language-mermaid');
        Prism.plugins.filterHighlightAll.reject.addSelector('pre.language-mermaid > code');
    </script>
    <!-- == end of prism == -->
...
<li>
<ul>
<li><a href="#layout-pagetitle-notespermalink-notes">layout: page
title: Notes
permalink: /notes/</a></li>
...
<li><a href="#sftp">SFTP</a></li>
  ...
  <div class="stackedit__right">
    <div class="stackedit__html">
      <hr>
<h2 id="layout-pagetitle-notespermalink-notes">layout: page<br>
title: Notes<br>
permalink: /notes/</h2>
...
<ol start="2">
<li>dump the collection to the directory</li>
</ol>
...
<p>Markdown  selection  29537  bytes 3814  words 1383  lines Ln 1384, Col 50</p>
<p>HTML 21768  characters 3451  words 718  paragraphs</p>
<p>SYNCHRONIZE</p>
<p>“notes.html” is already synchronized.</p>
<p>Synchronize now</p>
<p>Download / upload file changes.</p>
<p>1</p>
<p>File synchronization</p>
<p>Manage synchronized locations for “notes.html”.</p>
<hr>
<p>Open from GitHub</p>
<p>ojitha</p>
<p>Save on GitHub</p>
<p>ojitha</p>
<p>Save on Gist</p>
<p>ojitha</p>
<p>Open from Google Drive</p>
<p>Ojitha Kumanayaka</p>
<p>Save on Google Drive</p>
<p>Ojitha Kumanayaka</p>
<hr>
<p>Add Dropbox account</p>
<p>Add GitHub account</p>
<p>Add GitLab account</p>
<p>Add Google Drive account</p>
<blockquote>
<p>Written with <a href="https://stackedit.io/">StackEdit</a>.</p>
</blockquote>
